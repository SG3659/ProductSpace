...
const Event = () => {
   ...
   const itemsPerPage = events.length;
               ...
               {/*heading*/}
                  <div className='heading'>
                     ...
                     <div className='change-btn'>
                        <button className="custom-button" onClick={handlePrev} disabled={currentIndex === 0}>
                           <span className="icon">&lt;</span>
                        </button>
                        <button className="custom-button" onClick={handleNext} disabled={currentIndex + itemsPerPage >= events.length}>
                           <span className="icon">&gt;</span>
                        </button>
                     </div>
                  </div>
